...
namespace MIOConfig.PresentationLayer
{
    public class DeviceValidator
    {
        ...
        {
            ValidationErrorList.Clear();
            if (uartPort.PortProtocolType == Definitions.MODBUS_MASTER_PRTOCOL &&
            ...
            {
                if (uartPort.PortProtocolType == Definitions.MODBUS_SLAVE_PRTOCOL &&
                    _device.UartPortsConfigurations[port].PortProtocolType == Definitions.MODBUS_SLAVE_PRTOCOL &&
